...
<head>
    ...
    <style>
        ...
        .navbar-toggle {
            display: block;
            /* Show mobile menu icon by default */
            color: #000;
            /* Set menu button color to black */
            margin-right: 15px;
        ...
        /* Move mobile menu icon before logo */
        @media (max-width: 991px) {
            .navbar-custom .topnav-menu-left {
                flex-basis: 100%;
                order: -1;
                /* Move the mobile menu icon to the beginning */
                text-align: left;
            }
        }
    </style>
            ...
            <div class="container-fluid">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list topbar-dropdown">
                        <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-dark" data-toggle="dropdown"
                            href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img id="avatar" class="rounded-circle" width="60" height="60"
                                avatar="{{ Auth::user()->name }}">
                            <span class="pro-user-name ml-1" style="color: #000">
                ...
                <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                    <li>
                        <button class="button-menu-mobile waves-effect waves-dark navbar-toggle" style="color: #000">
                            <i class="fe-menu"></i>
                        </button>
                    </li>
                </ul>
                ...
                <div class="logo-box">
                    <a href="{{ route('dashboard') }}" class="logo logo-dark text-center">
                        <span class="logo-sm">
                            <img src="{{ asset('assets/images/logo.svg') }}" alt="GST Billing" width="100px">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('assets/images/logo.svg') }}" alt="GST Billing" width="100px">
                        </span>
